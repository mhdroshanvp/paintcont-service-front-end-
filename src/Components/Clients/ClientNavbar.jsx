...
function ClientNavbar() {
  ...
  return (
    <div variant="gradient" color="blue-gray"className=" w-full mx-auto max-w-screen-xl from-blue-gray-900 to-blue-gray-800 px-4 py-3 h-[60px] fixed z-50 bg-[#572c77]">
